            ...
            <div class="col-lg-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mt-3 rounded-0 bg-white mb-0 border-bottom">
                      <li class="breadcrumb-item active" aria-current="page"><a href="#"><i class="fas fa-home mr-1"></i>Ввод приказа о приеме ребенка</a></li>
                    </ol>
                    </nav>
                    <div class="container-fluid bg-white mb-3">
                        ...
                        <div class="col-lg-4">
                         ...
                         <div class="col-lg-4">
                    <div class="form-group">
                    <label from="id_groupp"> Группа </label>
						...
						<div class="col-lg-4">
          <div class="form-group">
            <label for="date_birthday">Дата_рождения</label>
            <input type="date" class="form-control" id="date_birthday" name="date_birthday">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="submit" name = "add" class="btn btn-success form-control" value="Добавить">
                            </div>
                        </div>
                    </form>
                    <div class="row">
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col">Вес</th>
                            <th scope="col">Пол</th>
                            <th scope="col">Сведения о родителе</th>
                            <th scope="col">Сведения о мед.карте</th>
                            <th scope="col">Отчисление ребенка</th>
														
                        </tr>
                    </thead>
                    <tbody>
							<?php foreach ($cheildrens as $item) { 
                            ...
                            echo '<td>'.$item['ves'].'</td>';
                            echo '<td>'.$item['pol'].'</td>';
                            echo '<td><button type="button" class="btn btn-primary updateModal " data-toggle="modal" data-target="#updateModal_P" data-cheildren="'.$item['id_Cheildren'].'" >Родитель</button></td>';
                            echo '<td><button type="button" class="btn btn-primary updateModal " data-toggle="modal" data-target="#updateModal_M" data-med_cart="'.$item['id_Cheildren'].'">Мед.карта</button></td>';
                            echo '<td><form method="POST" action="update_status_chl"><input type="hidden" name="id_cheildren" value="'.$item['id_Cheildren'].'"><button type="submit" class="btn btn-danger"><i class="fas fa-times"></i></button></form></td>';
							}							
							?>

            ...
            <div class="row">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mt-3 rounded-0 bg-white mb-0 border-bottom">
                      <li class="breadcrumb-item active" aria-current="page"><a href="#"><i class="fas fa-home mr-1"></i>Главная / Мед.процедуры</a></li>
                    </ol>
                </nav>
                <div class="container-fluid bg-white mb-3">
                    <form action="add_med_procedure" class="row pt-3" method="POST">
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-3">
                            <div class="form-group">
                                <h4>Фильтрация</h4>
                                <input type="text" class="form-control" id="med_procedure_name" name="med_procedure_name" placeholder="Введите название мед.процедуры">
                            </div>
                        </div>
                    <table class="table table-bordered" id="table-medProc">
                    ...
                    <?
                        ...
                        foreach($visible_med_cart_two as $item_med) {
